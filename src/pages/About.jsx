...
const About = () => {
  return (
    <>
      <Helmet>
        <title>Madhur Achanta | About</title>
        <meta
          name="description"
          content="Learn about Madhur Achanta's journey, technical skills, leadership experience, and project accomplishments in AI, React, and data-driven development."
        />
        <meta
          name="keywords"
          content="Madhur Achanta, About, Resume, Technical Skills, AI Projects, Developer, Entrepreneur, BBSC, Sri Vasavi Engineering College"
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Madhur Achanta | About" />
        <meta
          property="og:description"
          content="Explore Madhur Achanta’s background, certifications, leadership, and achievements in tech and business."
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:url"
          content="https://madhur-achanta.vercel.app/about"
        />
            ...
            <div className="space-y-16 lg:space-y-12">
              ...
              <div>
                ...
                <div className="mt-6 space-y-7 text-base text-zinc-600 dark:text-zinc-400">
                  ...
                  <p className="text-justify">
                    Currently, I’m working as a Founder’s Office – Generalist at Farmbowl, where I work across analytics, operations, automation, strategy, and growth initiatives to help build scalable systems and data-driven workflows.
                  </p>
                  <p className="text-justify">
              ...
              <div>
                ...
                <ul className="mt-6 space-y-4">
                  {[
                    ...
                    ["Mini Project: Research Paper Publication", "Automated YouTube Video Summarizer (LLaMA-3) at Springer CSEAi 2024"],
                    ["Major Project Paper Presentation", "Presented major project findings and implementation details"],
              ...
              <div>
                ...
                <ul className="mt-6 space-y-4">
                  {[
                    {
                      title: "AutoMate.ai",
                      desc: "A comprehensive AI-powered automation platform designed to streamline marketing in social media platforms.",
                    },
                    {
