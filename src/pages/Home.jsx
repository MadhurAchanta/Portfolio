  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="Madhur Achanta, software engineer, portfolio, React, AI, business metrics, personal assistant app"
        />
        <meta name="robots" content="index, follow" />
        <meta
          property="og:title"
          content="Madhur Achanta | Developer Portfolio"
        />
        <meta
          property="og:description"
          content="Explore projects and experiences of Madhur Achanta."
        />
        <meta
          property="og:image"
        ...
        <meta
          property="og:url"
          content="https://madhur-achanta.vercel.app"
        />
